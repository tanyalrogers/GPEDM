...
We can use the `predict` function to get other types of predictions. The following obtains sequential predictions using the training data. You could, alternatively, supply new data for which to make predictions. In that case, you would supply a new data frame (`datanew`), which should contain columns `Abundance` and `Population`. 
