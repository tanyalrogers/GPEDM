...
You could also supply new data for which to make predictions. In this case, you would supply a new data frame (`datanew`), which should contain columns `Abundance` and `Population`. 
