...
test=subset(round1, seriesnum==r1results$seriesnum[5])
...
res$results
plot(res, main=paste(test$model[5], test$ns[5]))
...
statistically NS, dynamically S
...
plot(ti,yii,type="l")
plot(dplyr::lag(yii),yii)
plot(ti,yiii,type="l")
plot(ti,yvi,type="l")

df=data.frame(ti=ti/100, yi=yi, yii=yii, yiii=yiii, yvi=yvi)
