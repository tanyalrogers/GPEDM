...
start=Sys.time()
tt=fitSmap(data=test, y="val", time="timestep", E=2, tau=1, scaling = "none", parallel = T)
end=Sys.time()
end-start
summary(tt)

start=Sys.time()
tt=fitSmap(data=test, y="val", time="timestep", E=2, tau=1, scaling = "none", thetafixed = 2)
end=Sys.time()
end-start
